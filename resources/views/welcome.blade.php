  ...
  <body>
      ...
      <div class="container">
        <div class="menu__wrapper">
          ...
          <a data-links class="menu__logo" href="#home"
            ><img src="images/login-logo.png" alt="logo da empresa Hogai"
          /></a>
        </div>
      </div>
    </div>
    ...
    <div class="modal__login" data-login>
        ...
        <div class="d-flex justify-content-between">
         <img class="max-w-logo" src="images/login-logo.png" alt="logo da empresa Hogai" />
        ...
        <form class="container__form">
            <div class="d-flex flex-column align-items-center gap-3 mt-5">
                ...
                <button class="login-with d-flex justify-content-center align-items-center gap-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="19.281" height="36" viewBox="0 0 19.281 36">
                    <path id="Icon_awesome-facebook-f" data-name="Icon awesome-facebook-f" d="M19.627,20.25l1-6.515H14.375V9.507c0-1.782.873-3.52,3.673-3.52h2.842V.44A34.658,34.658,0,0,0,15.846,0C10.7,0,7.332,3.12,7.332,8.769v4.965H1.609V20.25H7.332V36h7.043V20.25Z" transform="translate(-1.609)" fill="#073b4c"/>
                  </svg>
                  
                    Conecte-se com Facebook
                </button>
                <button class="login-with d-flex justify-content-center align-items-center gap-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="35.055" height="43.05" viewBox="0 0 35.055 43.05">
                    <path id="Icon_metro-apple" data-name="Icon metro-apple" d="M34.713,24.8a9.74,9.74,0,0,1,4.647-8.2,10.054,10.054,0,0,0-7.872-4.266c-3.352-.339-6.541,1.974-8.243,1.974s-4.323-1.924-7.1-1.873a10.533,10.533,0,0,0-8.9,5.4c-3.8,6.588-.972,16.347,2.728,21.69,1.808,2.615,3.964,5.553,6.795,5.448,2.726-.109,3.757-1.764,7.053-1.764s4.222,1.764,7.107,1.71c2.933-.054,4.792-2.665,6.588-5.289a23.73,23.73,0,0,0,2.982-6.122A9.508,9.508,0,0,1,34.713,24.8Zm-5.421-16a9.488,9.488,0,0,0,2.24-6.875,9.651,9.651,0,0,0-6.34,3.26,9.025,9.025,0,0,0-2.286,6.661A7.984,7.984,0,0,0,29.293,8.8Z" transform="translate(-5.435 -1.928)" fill="#073b4c"/>
                  </svg>
            ...
            <input class="custom__input" type="text" name="senha" id="senha" placeholder="Senha">
       
            <button type="submit" class="cta-btn my-4">Acessar</button>

            <p>Ainda não tem cadastro? <a style="color:rgb(6 214 160);text-decoration:none;" href="#">Cadastre-se aqui!</a></p>
        </form>
    </div>
          ...
          <div class="col-md-6">
            ...
            <div class="checkout__tipo d-flex justify-content-center gap-3">
              ...
              <div class="form-check checkout__container d-flex flex-column justify-content-center align-items-center checkout__ativo">
                ...
                <label class="form-check-label d-flex flex-column mt-3" for="cartao">
                  <img class="img-fluid" src="images/credit-card.png" alt="cartão de crédito" />
              ...
              <div class="form-check checkout__container d-flex flex-column justify-content-center align-items-center">
                ...
                <label class="form-check-label d-flex flex-column mt-3" for="boleto">
                  <img class="img-fluid" src="images/boleto.png" alt="boleto" />
                  <b>Boleto</b>
                </label>
              </div>
              ...
              <div class="form-check checkout__container d-flex flex-column justify-content-center align-items-center">
                ...
                <label class="form-check-label d-flex flex-column mt-3" for="pix">
                  <img class="img-fluid" src="images/pix.png" alt="pix" />
                  <b>Pix</b>
                </label>
              </div>
            </div>
            ...
            <div class="d-none mt-5" data-boleto-box>
              ...
              <div class="detalhes d-flex flex-column justify-content-between">
                ...
                <img class="max-w-bar" src="images/barcode.png" alt="código de barras"/>
              </div>
            </div>
    ...
    <header class="hero" id="home">
      <div class="container">
        ...
        <nav id="nav__fixed" class="d-flex justify-content-between align-items-center py-4" data-nav>
          ...
          <div class="logo" data-cadastro-btn>
            <img class="logo__img" src="images/login-logo.png" alt="logo">
        ...
        <section class="hero__content text-white">
          <div class="row">
            ...
            >
              <img class="img-fluid" src="images/logo.png" alt="simbolo da empresa Hogay" />
            </div>
      ...
      <div class="to__bottom d-flex justify-content-center">
        <a href="#footer"
          ...
          data-to-bottom
        >
          <img src="images/arrow.png" alt="seta apontando para baixo" />
        </a>
      </div>
    </header>
    ...
    <section class="why">
      <div class="container">
        <div class="row justify-content-center gap-3">
          ...
          <div class="col-md-6">
            <img class="img-fluid" src="images/mockup.png" alt="produto sendo mostrado em um computador e um smartphone" />
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center gap-3">
          ...
          <div class="col-md-6 d-flex justify-content-end order-md-1 my-3">
            <img class="img-fluid" src="images/phones-mockup.png" alt="produto sendo mostrado em um smartphone" />
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 d-flex justify-content-end order-md-1">
            <img src="images/toten.png" class="img-fluid qrcode__toten" alt="toten"/>
          </div>
    ...
    <footer id="footer">
      ...
      <div class="container">
        ...
        <div class="row justify-content-between">
          ...
          <div class="col-md-3">
            <img class="img-fluid" src="images/logo-footer.png" alt="logo" />
